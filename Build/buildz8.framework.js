...
var ASM_CONSTS = {
  6993048: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 6993103: ($0) => { performance.now = function() { return $0; }; },  
 6993151: ($0) => { performance.now = function() { return $0; }; },  
 6993199: () => { performance.now = Module['emscripten_get_now_backup']; }
};
