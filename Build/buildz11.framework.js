...
var ASM_CONSTS = {
  6995576: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 6995631: ($0) => { performance.now = function() { return $0; }; },  
 6995679: ($0) => { performance.now = function() { return $0; }; },  
 6995727: () => { performance.now = Module['emscripten_get_now_backup']; }
};
